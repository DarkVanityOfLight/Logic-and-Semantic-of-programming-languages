...
class Formula:
    ...
    def get_tt(self, pretty=False, assignments=None):
        ...
        pretty print is not set, a touple will be returned,
        representing the header of the table, and the table itself.
        First entry is the header, containing the variables in the
        order they are in the table, and the table, a list of list,
